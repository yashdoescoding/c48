...
function preload() {
  ...
  eatingSound = loadSound("pacman_chomp.wav")
}
...
player.collide(wall21);
  ...
  purpleGhost.collide(edges);
  purpleGhost.collide(wall1);
  purpleGhost.collide(wall2);
  purpleGhost.collide(wall3);
  purpleGhost.collide(wall4);
  purpleGhost.collide(wall5);
  purpleGhost.collide(wall6);
  purpleGhost.collide(wall7);
  purpleGhost.collide(wall8);
  purpleGhost.collide(wall9);
  purpleGhost.collide(wall10);
  purpleGhost.collide(wall11);
  purpleGhost.collide(wall12);
  purpleGhost.collide(wall13);
  purpleGhost.collide(wall14);
  purpleGhost.collide(wall15);
  purpleGhost.collide(wall16);
  purpleGhost.collide(wall17);
  purpleGhost.collide(wall18);
  purpleGhost.collide(wall19);
  purpleGhost.collide(wall20);
  purpleGhost.collide(wall21);
  purpleGhost.collide(wall22);
